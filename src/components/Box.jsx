...
const Box = ({ name, icon, link }) => {
  return (
    <div className="w-[162px] h-[120px] m-[5px] py-[7px] flex flex-col justify-between bg-[#2d2d2dcc] rounded-[10px] transition-all duration-300 hover:border hover:border-[#a273c2] hover:scale-110 cursor-pointer">
